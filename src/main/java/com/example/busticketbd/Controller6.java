...
public  class Controller6 implements Initializable {
    ...
    @FXML
    private Button Scene6Button1;

    @FXML
    private Button Scene6Button2;
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    for (int i = 0; i < s.length(); i++) {
                        ...
                        if (s.charAt(i) == 'J' && s.charAt(i + 1) == '1') {
                            J1.setDisable(true);
                        }
                        if (s.charAt(i) == 'J' && s.charAt(i + 1) == '2') {
                            J2.setDisable(true);
                        }
                        if (s.charAt(i) == 'J' && s.charAt(i + 1) == '3') {
                            J3.setDisable(true);
                        }
                    }
                }
