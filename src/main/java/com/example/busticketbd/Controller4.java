...
public  class Controller4 implements Initializable {
    ...
    @FXML
    private Button Scene4Button2;

    @FXML
    private Label Scene4Label1;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < s.length(); i++) {
                    ...
                    if (s.charAt(i) == 'A' && s.charAt(i + 1) == '4') {
                        A4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'B' && s.charAt(i + 1) == '4') {
                        B4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'C' && s.charAt(i + 1) == '4') {
                        C4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'D' && s.charAt(i + 1) == '4') {
                        D4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'E' && s.charAt(i + 1) == '4') {
                        E4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'F' && s.charAt(i + 1) == '4') {
                        F4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'G' && s.charAt(i + 1) == '4') {
                        G4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'H' && s.charAt(i + 1) == '4') {
                        H4.setDisable(true);
                    }
                    ...
                    if (s.charAt(i) == 'I' && s.charAt(i + 1) == '4') {
                        I4.setDisable(true);
                    }
                }
            }
    ...
    public void switchttoinfo(ActionEvent event) throws IOException{
        if((A1.isSelected() || A2.isSelected() || A3.isSelected() || A4.isSelected() || B1.isSelected() || B2.isSelected() || B3.isSelected() || B4.isSelected() || C1.isSelected() || C2.isSelected() || C3.isSelected() || C4.isSelected() || D1.isSelected() || D2.isSelected() || D3.isSelected() || D4.isSelected() || E1.isSelected() || E2.isSelected() || E3.isSelected() || E4.isSelected() || F1.isSelected() || F2.isSelected() || F3.isSelected() || F4.isSelected() || G1.isSelected() || G2.isSelected() || G3.isSelected() || G4.isSelected() || H1.isSelected() || H2.isSelected() || H3.isSelected() || H4.isSelected() || I1.isSelected() || I2.isSelected() || I3.isSelected() || I4.isSelected()) && boarding!=null) {
